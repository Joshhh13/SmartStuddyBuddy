...
namespace SmartStudyBuddy
{
    ...
    {
        private static StudyBuddy instance;
        ...
        private void SetupEmailTextBox()
        {
            ...
            roundedTextBox1.Text = emailPlaceholder;

            roundedTextBox1.Enter += (object s, EventArgs args) =>
            {
                if (roundedTextBox1.Text == emailPlaceholder)
                {
        ...
        private void SetupPasswordTextBox()
        {
            ...
            roundedTextBox2.Text = passwordPlaceholder;
            roundedTextBox2.PasswordChar = '\0';

            roundedTextBox2.Enter += (object s, EventArgs args) =>
            {
                if (roundedTextBox2.Text == passwordPlaceholder)
                {
        ...
        public static StudyBuddy GetInstance()
        {
            if (instance == null || instance.IsDisposed)
            {
                instance = new StudyBuddy();
            }
            return instance;
        }
